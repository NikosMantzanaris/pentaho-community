...
//        toolsMenu.addSeparator();
    ...
    MenuItem refreshItem = new MenuItem(Messages.getString("refresh"), SolutionBrowserPerspective.getInstance().isWorkspaceShowing() ? new RefreshWorkspaceCommand() : new RefreshRepositoryCommand());
