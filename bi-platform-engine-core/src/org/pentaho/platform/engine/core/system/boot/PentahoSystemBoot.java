...
public class PentahoSystemBoot {
   ...
   */
  protected void configure(String userFilePath, String fullyQualifiedServerUrl, IPentahoDefinableObjectFactory userFactory) {
    setFilePath(userFilePath != null?userFilePath:new File(".").getAbsolutePath()); //$NON-NLS-1$
    
    setFullyQualifiedServerUrl(fullyQualifiedServerUrl != null? fullyQualifiedServerUrl:"http://localhost:8080/pentaho/"); //$NON-NLS-1$
