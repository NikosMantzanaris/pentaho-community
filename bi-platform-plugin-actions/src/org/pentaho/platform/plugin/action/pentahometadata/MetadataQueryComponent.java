...
public class MetadataQueryComponent {
  ...
  String query;
  Integer maxRows; // null means not assigned;
  Integer timeout; // null means not assigned;
...
//    String modelType = (String) inputs.get("modeltype");
    ...
    if( executor == null ) {
      ...
      try {
        ...
        logger.error(Messages.getErrorString("MetadataQueryComponent.ERROR_0002_NO_EXECUTOR",queryExecName)); //$NON-NLS-1$
        return false;
      }
    }
