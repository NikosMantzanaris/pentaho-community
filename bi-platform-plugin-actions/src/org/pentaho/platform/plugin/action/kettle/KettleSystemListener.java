...
public class KettleSystemListener implements IPentahoSystemListener {
  ...
  public boolean startup(final IPentahoSession session) {
    ...
    try {
      ...
      if (repository.resourceExists(slaveServerConfigFilename, ISolutionRepository.ACTION_EXECUTE)) {
        InputStream is = repository.getResourceInputStream(slaveServerConfigFilename, false, ISolutionRepository.ACTION_EXECUTE);
