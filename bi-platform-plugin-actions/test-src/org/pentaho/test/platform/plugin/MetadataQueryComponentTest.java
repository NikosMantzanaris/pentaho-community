...
//    microPlatform.define("metadataqueryexec-SQL", org.pentaho.platform.plugin.services.connections.metadata.sql.SqlMetadataQueryExec.class);
  ...
  public void testMultiValuedParameters() {
    ...
    component = new MetadataQueryComponent();
    Map<String, Object> inputs = new HashMap<String, Object>();
    inputs.put("param1", new String[] {"BG&E Collectables","Baane Mini Imports", "Bavarian Collectables Imports, Co.", "Boards & Toys Co."});
    component.setInputs(inputs);
    component.setQuery(mql);
    component.execute();
    ...
    mql = "<mql><domain_id>DOMAIN</domain_id><model_id>MODEL</model_id>" +
