...
public class WebApplicationContext extends StandaloneApplicationContext {
  ...
  public WebApplicationContext(final String solutionRootPath, final String fullyQualifiedServerUrl, final String applicationPath, final Object context) {
  ...
  public WebApplicationContext(final String solutionRootPath, final String fullyQualifiedServerUrl, final String applicationPath) {
