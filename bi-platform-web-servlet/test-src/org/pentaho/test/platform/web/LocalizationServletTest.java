...
public class LocalizationServletTest {
  ...
  public void getBundle_invalid_plugin() {
    ...
    try {
      ...
      assertTrue("Unexpected exception: " + ex.getCause().getMessage(), ex.getCause().getMessage().contains("LocalizationServlet.ERROR_0001"));
    }
  }
  ...
  public void getBundle_invalid_name() {
    ...
    try {
      ...
      assertTrue(ex.getCause() instanceof IllegalArgumentException);
      assertTrue("Unexpected exception: " + ex.getCause().getMessage(), ex.getCause().getMessage().contains("LocalizationServlet.ERROR_0002"));
    }
  ...
  public void isMessageCachingEnabled() {
    ...
    assertFalse(ls.isMessageCachingEnabled(PentahoSystem.get(IPluginManager.class), TestPluginProvider.TEST_PLUGIN_2));
  }
