  ...
  protected void doGet(final HttpServletRequest req, final HttpServletResponse resp) throws ServletException, IOException {
    ...
    try {
      ...
      if(dse.getCause() instanceof ClassNotFoundException) {
    	  MondrianCatalogPublisher.logger.error(Messages.getErrorString("MondrianCatalogPublisher.ERROR_0009_DATASOURCE_DRIVER_MISSING", jndiName), dse); //$NON-NLS-1$
    	  resp.getWriter().println(DATASOURCE_DRIVER_MISSING);
      } else {
