...
public class ApplicationContextTest extends BaseTest {
  ...
  public void testPortletApplicationContext() {
    ...
    assertEquals(pac.getFullyQualifiedServerURL(), "http://localhost:8080/pentaho/"); //$NON-NLS-1$    
  ...
  public void testWebApplicationContext() {
    ...
    wac.setFullyQualifiedServerURL("http://localhost:8080/pentaho");
//    String url = wac.getBaseUrl();
    ...
    wac1.setFullyQualifiedServerURL("http://localhost:8080/pentaho");

    assertEquals(wac.getFullyQualifiedServerURL(), "http://localhost:8080/pentaho/"); //$NON-NLS-1$    
    assertEquals(wac.getSolutionRootPath(), PentahoSystem.getApplicationContext().getSolutionPath("test")); //$NON-NLS-1$
      
    assertEquals(wac1.getFullyQualifiedServerURL(), "http://localhost:8080/pentaho/"); //$NON-NLS-1$    
