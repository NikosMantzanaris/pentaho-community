...
public class PluginResourceLoader implements IPluginResourceLoader {
  ...
  public String getPluginSetting(Class<?> pluginClass, String key, String defaultVal) {
    ...
    if( pluginPath == null ) {
      Logger.debug(this, Messages.getString(
    ...
    if(!settingsFile.exists()){
      Logger.debug(this, Messages.getErrorString("SYSTEMSETTINGS.ERROR_0002_FILE_NOT_IN_SOLUTION", settingsFile.getAbsolutePath())); //$NON-NLS-1$
      return defaultVal;
    }
