...
public class IsOutputParameterTest extends BaseTest {
  ...
  public void testIsOutputParameter() throws XmlParseException {
    ...
    IActionSequence actionSequence = SequenceDefinition.ActionSequenceFactory(actionSequenceDocument, xactionName,
        "", ISolutionEngine.RUNTIME_SOLUTION_NAME, this, PentahoSystem.getApplicationContext(), DEBUG); //$NON-NLS-1$
