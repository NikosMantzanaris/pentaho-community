  ...
  public String backgroundExecuteAction(IPentahoSession userSession, IParameterProvider parameterProvider) throws BackgroundExecutionException {
    try {
      ...
      if (null != cronString) {
        ...
        Date startDate = parameterProvider.getDateParameter(StandardSettings.START_DATE_TIME, null);
        Date endDate = parameterProvider.getDateParameter(StandardSettings.END_DATE_TIME, null);
