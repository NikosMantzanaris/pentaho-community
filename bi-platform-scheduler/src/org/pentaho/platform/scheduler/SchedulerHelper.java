...
public class SchedulerHelper {
  ...
  // SERASOFT - Fix problem with scheduling from PUC - BISERVER-3430
  public static CronTrigger createCronTrigger( String triggerName, String triggerGroupName,
      Date startDate, Date endDate, String cronString ) throws ParseException {
  ...
  public static CronTrigger createCronTrigger( String triggerName, String triggerGroupName,
    ...
    if (strStartDate != null) {
      try {
        ...
        startDate = new Date(Date.parse( strStartDate ));
      }
    }
    ...
    if (strEndDate != null) {
      try {
        ...
        endDate = new Date(Date.parse( strEndDate ));
      }
    }
  ...
  // SERASOFT - Fix problem with scheduling from PUC - BISERVER-3430
    public static SimpleTrigger createRepeatTrigger( String triggerName, String triggerGroupName,
        Date startDate, Date endDate, String repeatCount, String strRepeatInterval ) throws ParseException {
