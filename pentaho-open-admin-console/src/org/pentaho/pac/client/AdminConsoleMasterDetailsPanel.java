...
public class AdminConsoleMasterDetailsPanel extends DockPanel  implements ClickListener{
  ...
  protected class RightPanel extends DockPanel{
    ...
    public int getSelectedPage() {
      ...
      Widget selectedPage = deckPanel.getWidget(deckPanel.getVisibleWidget());
      for (Map.Entry<Integer, PageInfo> entry : pageMap.entrySet()) {
        if (entry.getValue().page == selectedPage) {
          selectedPageId = entry.getKey();
          break;
        }
      }
  ...
  public int getSelectedPageId() {
    return rightPanel.getSelectedPage();
  }
