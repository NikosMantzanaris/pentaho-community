 ...
 * To install this class, you need to do the following:
 ...
 <li>Below the close of the definition of the <code>daoAuthenticationProvider</code> bean, create the <code>ldapContextMapper</code> bean as shown - make sure you update the property name to match your environment. The default is <code>samAccountName</code></li>
 <pre>
...
public class UseridAttributeLdapContextMapper extends LdapUserDetailsMapper {
  ...
  public UserDetails mapUserFromContext(DirContextOperations ctx, String username, GrantedAuthority[] authorities) {
    ...
    if (usernameAttributeValue == null) {
      throw new IllegalStateException(
          Messages.getErrorString("UseridAttributeLdapContextMapper.ERROR_0001_ATTRIBUTE_NOT_FOUND", getLdapUsernameAttribute()));
    }
   ...
   * <p>Example - <code>cn</code>
   * <p>Default value: <code>samAccountName</code>
   * <p>Set the value as a bean property in the <code>applicationContext-spring-security-ldap.xml</code>
   * @param value
   */
